...
public class FunctionDeclaration__ extends Declaration__ implements IFunctionDeclaration {
	...
	public FunctionDeclaration__(int line, int posInLine, String text, IIdentifier name, List<INameDef> args,
